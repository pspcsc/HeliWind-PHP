            ...
            <?php foreach ($slides as $index => $slide): ?>
                <div class="carousel-item h-100 <?php echo $index === 0 ? 'active' : ''; ?>">
                    <div class="position-relative h-100" style="min-height:88vh;">
                        <img src="<?php echo e($slide['image'] ?? ''); ?>" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="<?php echo e($slide['title'] ?? 'HeliWind Slide'); ?>">
                            ...
                            <div class="container py-5">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 text-white py-5">
                                        <span class="badge rounded-pill text-bg-warning text-uppercase mb-3"><?php echo e($slide['kicker'] ?? 'HeliWind Energy Solution'); ?></span>
                                        ...
                                        <a class="btn btn-success btn-lg rounded-pill px-4" href="<?php echo e($slide['button_link'] ?? '#contact'); ?>"><?php echo e($slide['cta'] ?? 'Know More'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
